...
赋值给了 vm._update 函数⾥调⽤的 vm.__patch__ */
export function createPatchFunction (backend) {
  ...
  */
  ...
  // 把 DOM 插⼊到⽗节点中 调⽤⼀些 nodeOps 把⼦节点插⼊到⽗节点中
  ...
  // createChildren ⽅法去创建⼦元素 遍历⼦虚拟节点， 递归调⽤ createElm
  ...
  /*调用创建的钩子函数 执⾏所有的 create 的钩⼦并把 vnode push 到
